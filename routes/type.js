...
const {createType, getAllTypes, getType, updateType, deleteType, popoulateType} = require("../controllers/type");
const {verifyToken, authorize} = require("../middleware/auth");
const advancedResults = require("../middleware/advancedResults");


router.post("/", verifyToken, authorize("HR", "Admin", "Manager"), createType); // create a type
router.get("/", advancedResults(Type, popoulateType), getAllTypes); // get all types
